...
let tokenJWT = new TokenJWT(process.env.JWT_SECRET_KEY || '1234', process.env.JWT_EXSPIRES_TIME || '5hr');
let userRepository = new UserRepository();
let registerUserCase = new RegisterUserCase(userRepository, tokenJWT);
let loginUserCase = new LoginUserCase(userRepository, tokenJWT);
let userController = new UserController(registerUserCase, loginUserCase);
